...
// Source: github.com/olaniyi38/BE/db/sqlc (interfaces: Store)
//
...
func (m *MockStore) UpdateUserData(ctx context.Context, arg db.UpdateUserDataParams) (db.User, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateUserData", ctx, arg)
	ret0, _ := ret[0].(db.User)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockStoreMockRecorder) UpdateUserData(ctx, arg any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateUserData", reflect.TypeOf((*MockStore)(nil).UpdateUserData), ctx, arg)
}
